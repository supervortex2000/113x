...
echo "Remove udev resource"
rm -fv $TARGET_DIR/etc/init.d/S10udev
rm -fv $TARGET_DIR/lib/dhcpcd/dev/udev.so
rm -fv $TARGET_DIR/lib/libudev.so.1.6.3
rm -fv $TARGET_DIR/lib/libudev.so.1
rm -fv $TARGET_DIR/lib/udev
rm -fv $TARGET_DIR/sbin/udevd
rm -fv $TARGET_DIR/sbin/udevadm
rm -fv $TARGET_DIR/etc/udev
rm -fv $TARGET_DIR/usr/bin/udevadm
rm -fv $TARGET_DIR/usr/lib/libudev.so
