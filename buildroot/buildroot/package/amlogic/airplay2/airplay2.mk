...
AIRPLAY2_DEPENDENCIES = mdnsresponder alsa-lib fdk-aac aml-commonlib
...
AIRPLAY2_MAKE_OPTS += EXT_INCLUDES="-I$(STAGING_DIR)/usr/include/alsa -I$(STAGING_DIR)/usr/include -I$(STAGING_DIR)/usr/include/fdk-aac" EXT_LINKFLAGS="-ldns_sd -lasound -lfdk-aac"
...
define AIRPLAY2_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) CC=$(TARGET_CC) CROSSPREFIX=$(TARGET_CROSS) $(AIRPLAY2_MAKE_OPTS) -C $(@D)/AirPlaySDK/PlatformPOSIX
