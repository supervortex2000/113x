...
BLUEZ_ALSA_DEPENDENCIES += bluez5-utils
...
define BLUEZ_ALSA_POST_INSTALL_TARGET_CMD
    cp $(BLUEZ_ALSA_PKGDIR)/bluealsa_profilecfg.sh $(TARGET_DIR)/etc/init.d
endef

ifneq ($(BR2_AVS_BLUETOOTH_ENABLE),y)
    BLUEZ_ALSA_POST_INSTALL_TARGET_HOOKS += BLUEZ_ALSA_POST_INSTALL_TARGET_CMD
endif
