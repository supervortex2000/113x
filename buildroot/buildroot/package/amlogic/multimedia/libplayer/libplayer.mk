...
LIBPLAYER_DEPENDENCIES = zlib alsa-lib libcurl $(if $(BR2_PACKAGE_LIBXML2),libxml2) linux dtv-audio-utils
...
export BR2_PACKAGE_LIBPLAYER_BASE_LIBS
...
ifneq ($(BR2_PACKAGE_LIBPLAYER_BASE_LIBS),y)
...
ifeq ($(BR2_PACKAGE_AML_SOC_CHIP_NAME), "S905X4")
LIBPLAYER_MAKE_ENV = CFLAGS="$(TARGET_CFLAGS) -fPIC -DDVB_AUDIO_SC2"
else
LIBPLAYER_MAKE_ENV = CFLAGS="$(TARGET_CFLAGS)"
endif


define LIBPLAYER_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(LIBPLAYER_MAKE_ENV) ARCH=$(BR2_ARCH) $(MAKE) -C $(@D) all
