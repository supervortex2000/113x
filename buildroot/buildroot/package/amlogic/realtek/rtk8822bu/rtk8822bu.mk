...
ifeq ($(BR2_PACKAGE_RTK8822BU_LOCAL),y)
RTK8822BU_SITE = $(call qstrip,$(BR2_PACKAGE_RTK8822BU_LOCAL_PATH))
RTK8822BU_SITE_METHOD = local
endif
...
define RTK8822BU_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0666 $(@D)/rtl8822BU/88x2bu.ko $(RTK8822BU_INSTALL_DIR)
	echo $(RTK8822BU_MODULE_DIR)/88x2bu.ko: >> $(TARGET_DIR)/lib/modules/$(LINUX_VERSION_PROBED)/modules.dep
endef
else
