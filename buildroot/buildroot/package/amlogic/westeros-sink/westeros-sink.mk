...
WESTEROS_SINK_VERSION = 607510644c10059271c389e345fe9d4fe9bddfed
...
WESTEROS_SINK_DEPENDENCIES = host-pkgconf host-autoconf westeros libegl libdrm \
              gstreamer1 gst1-plugins-base gst-plugin-aml-asink host-patchelf
...
ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
	...
	WESTEROS_SINK_MAKE_ENV += PKG_CONFIG_SYSROOT_DIR=${STAGING_DIR} 
	WESTEROS_SINK_MAKE_ENV += STAGING_INCDIR=${STAGING_DIR}/usr/include 
endif
...
define WESTEROS_SINK_FIX_RPATH
	$(HOST_DIR)/bin/patchelf --set-rpath /usr/lib/gstreamer-1.0 \
		$(TARGET_DIR)/usr/lib/gstreamer-1.0/libgstwesterossink.so
endef
WESTEROS_SINK_POST_INSTALL_TARGET_HOOKS += WESTEROS_SINK_FIX_RPATH
