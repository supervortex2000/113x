...
WESTEROS_SOC_VERSION = 607510644c10059271c389e345fe9d4fe9bddfed
...
WESTEROS_SOC_DEPENDENCIES = host-pkgconf host-autoconf wayland libegl libglib2
...
ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
	...
	WESTEROS_SOC_CONF_OPTS += CFLAGS="$(TARGET_CFLAGS) -DUSE_AMLOGIC_MESON -I $(STAGING_DIR)/usr/include/libdrm"
	WESTEROS_SOC_CONF_OPTS += LDFLAGS="$(TARGET_LDFLAGS) -lamlavsync"
	WESTEROS_SOC_SUBDIR = drm
	WESTEROS_SOC_DEPENDENCIES += libdrm avsync-lib
endif

define WESTEROS_SOC_RUN_AUTOCONF
	mkdir -p $(@D)/$(WESTEROS_SOC_SUBDIR)/cfg
	mkdir -p $(@D)/$(WESTEROS_SOC_SUBDIR)/m4
endef
