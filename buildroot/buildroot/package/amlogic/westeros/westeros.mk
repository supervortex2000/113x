...
#
################################################################################
WESTEROS_VERSION = 607510644c10059271c389e345fe9d4fe9bddfed
...
WESTEROS_DEPENDENCIES = host-pkgconf host-autoconf wayland libdrm \
...
ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
	...
	WESTEROS_MAKE_OPTS += PKG_CONFIG_SYSROOT_DIR=$(STAGING_DIR)
