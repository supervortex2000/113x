...
$(Q) case "$(1)" in \
	...
	AP6201BM) \
		mkdir -p $(TARGET_DIR)/etc/wifi/AP6201; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM/Wi-Fi/clm_bcm43013c1_ag.blob      $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM/Wi-Fi/fw_bcm43013c1_ag_apsta.bin  $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM/Wi-Fi/fw_bcm43013c1_ag.bin        $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM/Wi-Fi/nvram_ap6201.txt            $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM/BT/BCM43013A0.hcd                 $(TARGET_DIR)/etc/bluetooth/; \
		;; \
	AP6201BM_MINIME) \
		mkdir -p $(TARGET_DIR)/etc/wifi/AP6201; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM_MINIME/Wi-Fi/clm_bcm43013c1_ag.blob      $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM_MINIME/Wi-Fi/fw_bcm43013c1_ag_apsta.bin  $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM_MINIME/Wi-Fi/fw_bcm43013c1_ag.bin        $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM_MINIME/Wi-Fi/nvram_ap6201.txt            $(TARGET_DIR)/etc/wifi/AP6201/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/AP6201BM_MINIME/BT/43013A0.hcd                 $(TARGET_DIR)/etc/bluetooth/; \
		;; \
esac;
...
ifeq ($(BR2_LINUX_KERNEL_VERSION),"amlogic-5.4-dev")
define INSTALL_WIFI_MODULE
$(Q) case "$(1)" in \
	AP6398) \
		mkdir -p $(TARGET_DIR)/etc/wifi/AP6398;\
	...
	AP6255) \
		mkdir -p $(TARGET_DIR)/etc/wifi/6255; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/6255/*.bin                    $(TARGET_DIR)/etc/wifi/6255/;   \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/6255/nvram.txt                    $(TARGET_DIR)/etc/wifi/6255/nvram_ap6255.txt;   \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/config.txt                            $(TARGET_DIR)/etc/wifi/6255/;   \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/6255/BT/*.hcd                       $(TARGET_DIR)/etc/bluetooth/;   \
		;; \
	bcm4356) \
		mkdir -p $(TARGET_DIR)/etc/wifi/4356; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/4356/*.bin $(TARGET_DIR)/etc/wifi/4356/; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/4356/nvram*.txt $(TARGET_DIR)/etc/wifi/4356/nvram_ap6356.txt; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/4356/config.txt $(TARGET_DIR)/etc/wifi/4356/config.txt; \
		$(INSTALL) -D -m 0644 $(@D)/bcm_ampak/config/4356/bcm4356a2.hcd $(TARGET_DIR)/etc/bluetooth/BCM4354.hcd; \
		;; \
esac;
...
ifeq ($(BR2_LINUX_KERNEL_VERSION),"amlogic-5.10-dev")
define INSTALL_WIFI_MODULE
$(Q) case "$(1)" in \
	AP6398) \
		mkdir -p $(TARGET_DIR)/etc/wifi/AP6398;\
