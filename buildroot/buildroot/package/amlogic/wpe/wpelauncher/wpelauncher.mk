...
define WPELAUNCHER_BINS
	$(INSTALL) -D -m 0644 package/amlogic/wpe/wpelauncher/wpe.{txt,conf} $(BINARIES_DIR)/
	$(INSTALL) -D -m 0755 package/amlogic/wpe/wpelauncher/wpe $(TARGET_DIR)/usr/bin
endef

define WPELAUNCHER_AUTOSTART
	$(INSTALL) -D -m 0755 package/amlogic/wpe/wpelauncher/S90wpe $(TARGET_DIR)/etc/init.d
endef
