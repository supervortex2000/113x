...
WPEWEBKIT_VERSION_VALUE = 405564d67c5bcbb187be2447eea84df24cc44a94 # wpe-2.22
endif
...
WPEWEBKIT_DEPENDENCIES += wpebackend-rdk libgcrypt libgles libegl libepoxy cairo freetype \
...
WPEWEBKIT_DEPENDENCIES += gstreamer1 gst1-plugins-base gst1-plugins-good gst1-plugins-bad gst-aml-drm-plugins1
WPEWEBKIT_FLAGS += \
	-DENABLE_VIDEO=ON \
...
WPEWEBKIT_FLAGS += -DBUILD_SHARED_LIBS=ON
...
WPEWEBKIT_SYMBOL_FLAGS += -lgstsecmemallocator
WPEWEBKIT_EXTRA_FLAGS += \
...
WPEWEBKIT_PKGDIR = "$(TOP_DIR)/package/amlogic/wpe/wpewebkit"
