...
ANDROID_TOOLS_CFLAGS = '-fstack-protector-all -s -fPIE -pie -z now -z noexecstack -O2 -D_FORTIFY_SOURCE=2'
...
define ANDROID_TOOLS_BUILD_CMDS
	$(foreach t,$(ANDROID_TOOLS_TARGETS),\
		...
		$(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_OPTS) $(MAKE) SRCDIR=$(@D) \
			CFLAGS=$(ANDROID_TOOLS_CFLAGS) -C $(@D)/build-$(t) -f $(@D)/debian/makefiles/$(t).mk$(sep))
endef
