...
DHCPCD_VERSION = 9.2.0
DHCPCD_SOURCE = v$(DHCPCD_VERSION).tar.gz
DHCPCD_SITE = https://github.com/NetworkConfiguration/dhcpcd/archive/refs/tags
...
DHCPCD_CONFIG_OPTS += CFLAGS='-fstack-protector-all -s -fPIE -pie -z now -z noexecstack -O2 -D_FORTIFY_SOURCE=2'

#TARGET_CPPFLAGS += -fstack-protector-all -s -fPIE -pie -z now -z noexecstack -O2 -D_FORTIFY_SOURCE=2
