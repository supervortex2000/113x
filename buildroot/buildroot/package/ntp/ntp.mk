...
#workaround for BR2020.02
NTP_AUTORECONF_OPTS += -I "$(STAGING_DIR)/usr/share/aclocal" -I "$(STAGING_DIR)/../../share/aclocal"
...
NTP_CONF_OPTS += CFLAGS='-fstack-protector-all -s -fPIE -pie -z now -z noexecstack -O2 -D_FORTIFY_SOURCE=2'
