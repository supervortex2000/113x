...
define SECFIRMLOAD_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 644 $(@D)/$(BR2_ARCH).$(CC_TARGET_ABI_).$(CC_TARGET_FLOAT_ABI_)/libtee_preload_fw.so  $(TARGET_DIR)/usr/lib/
	$(INSTALL) -D -m 644 $(@D)/noarch/ta/v$(BR2_PACKAGE_TDK_VERSION)/526fc4fc-7ee6-4a12-96e3-83da9565bce8.ta   $(TARGET_DIR)/lib/teetz/
